...
export class BuyInUI {
  constructor() {
    ...
    this.updateBalancesAfterTransfer = (updatedGlobalBalance, updatedTableBalance) => {
      ...
      transferMaxSpan.innerText = roundWithFormatAmount(getRoundValue(updatedGlobalBalance));
    ...
    buyInConfirm.addEventListener('click', () => {
      ...
      if (this.currentBuyInAmount - this.currentTableMoney <= 0)
        return;
            ...
            this.setBuyInValidValue(getMoneyOriginalValue(parseFloat(newTableBalanceInput.value)).toFixed(2));
    ...
    addedBalanceInput.addEventListener('change', () => {
      this.setBuyInValidValue(getMoneyOriginalValue(parseFloat(addedBalanceInput.value).toFixed(2)) + this.currentTableMoney);
    });
  ...
  setBlinds(sb, bb) {
    ...
    setBuyInRange(minBuyIn, maxBuyIn) {
        ...
        buyInMinSpan.innerText = roundWithFormatAmount(getMoneyValue(minBuyIn));
        buyInMaxSpan.innerText = roundWithFormatAmount(getMoneyValue(maxBuyIn));
    ...
    setTransferRange(minTransfer, maxTransfer) {
        ...
        transferMinSpan.innerText = roundWithFormatAmount(getMoneyValue(minTransfer));
        transferMaxSpan.innerText = roundWithFormatAmount(getMoneyValue(maxTransfer));
