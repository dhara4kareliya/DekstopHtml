...
export function getMoneyText(amount) {
    ...
    if (showcurrency == "BB") {
        ...
        var img = document.createElement("img");
        img.src = "./images/desktop/xrp_coin.png";
...
// export function getActionMoneyText(amount) {
//     if (amount == undefined)
//         amount = 0;
...
//     } else {
//         var img = document.createElement("img");
//         img.src = "./images/desktop/coin.png";
//         container.classList.add("imageFeatures");
//         container.appendChild(img);
//         const amountText = document.createElement("span");
//         amountText.innerText = ` ${roundWithFormatAmount(amount)}`;
...
export function getMoneyValue(amount) {
    ...
    if (showcurrency == "BB") {
        return round2(Math.floor(round2(amount / bigBlind * 100)) / 100);
    } else if (showcurrency == "USD") {
        return round2(Math.floor(round2(amount * usdRate * 100)) / 100);
    }
